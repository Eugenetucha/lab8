...
namespace lab8.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<Note> BuildAllNotes()
        {
            ...
            {
                new Note("Фоменко Евгений Валерьевич","2","1","2","0","1","1","2",false),
                new Note("Фуфаев Владимир Альбертович","1","1","1","1","1","1","1",false),
                new Note("Духаст Иван Вячеславович","2","0","0","0","2","0","0",false),
            };
        }
